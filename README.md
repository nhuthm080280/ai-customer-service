...
Tests introduction video: https://www.loom.com/share/1eea8a55d532439f87a0af3585dcf96a?t=4
...
Make a loom showing and explaining all the code and the working web app in action. Use the same tech stack described above. Also make a public github repo so I can easier review the code.
...
Make the table nice
Use Web awesome for components like buttons
...
Add a delete button to delete a product from the database, make sure to have a <dialog> to confirm the deletion.
One more feature, which you decide yourself
